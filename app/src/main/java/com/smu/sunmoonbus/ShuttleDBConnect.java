...
public class ShuttleDBConnect {
    ...
    //위치 업로드
    public static void sendLocation(String targetBusID, double latitude, double longitude) {
        myRef1.child(targetBusID).child("latitude").setValue(latitude);
        myRef1.child(targetBusID).child("longitude").setValue(longitude);
    }
